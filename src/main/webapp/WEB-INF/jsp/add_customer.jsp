...
<div class="container" >
                ...
                <h5><p><font color = "red"> <c:out value="${error}" /></ font><p></h5></c:if>

<h3> <p><font color = "#3594B4"><fmt:message bundle="${loc}" key="language.addInfo"/></ font> </p></h3>
...
<div class="card h-60">
		...
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
            				<div class="form-group">
            					...
            					<input type="text" class="form-control" name="last_name" placeholder="<fmt:message bundle="${loc}" key="language.enterLName"/>">
            				</div>
            			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
            				<div class="form-group">
    ...
    <div class="col-md-10 p-lg-2 mx-auto my-0">
              ...
              <a class="btn btn-outline-secondary" href="${pageContext.request.contextPath}/shop?command=go_to_profile"> <fmt:message bundle="${loc}" key="language.addLater"/> </a>
  </div>
  </div>
