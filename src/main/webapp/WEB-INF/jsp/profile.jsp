   ...
   <body>
      ...
      <div class= "bg-light">
                        ...
                        <div class="card">
                           <div class="card-body">
                              <div class="d-flex flex-column align-items-center text-center">
                                 <img src="images/avatar.png"  class="rounded-circle" width="100">
                                 <div class="mt-3">
         ...
         <c:if test="${sessionScope.role.name == 'admin'}">
            ...
            <h5>
            <ul class="nav justify-content-left border-bottom pb-1 mb-1">
               <li class="nav-item">
            ...
            <div class="position-relative text-center bg-light">
               <p><img src="images/admin.jpg" height="70%" width="60%" ></p>
            </div>
         </c:if>
      </div>
   </body>
