   ...
   <body>
      ...
      <c:if test="${products.size() > 0}">
         <div align="center" class= "bg-light">
            ...
            <table border="0" cellpadding="6">
                  <tr>
                     <th>
                        <fmt:message bundle="${loc}" key="language.title"/>
                     </th>
                     <th>
                        <fmt:message bundle="${loc}" key="language.description"/>
                     </th>
                     <th>
                        <fmt:message bundle="${loc}" key="language.price"/>
                     </th>
                  </tr>
               <c:forEach var="product" items="${products}">
                  <tr>
                     ...
                     <td>
                        <c:if test="${(pay == null) && (error == null) && (block == null) && (refuse == null) }">
               ...
               <tr>
                  <td>
                     <h5>
                        <font color = "#082344">
                        <fmt:message bundle="${loc}" key="language.cost"/>
                        ${order_price} </ font>
                     </h5>
                  <td>
                     <c:if test="${(pay == null) && (error == null) && (block == null) && (refuse == null) }">
               ...
               <td>
                  <c:if test="${error}">
                     <h5>
                     <font color = "red">
                     <fmt:message bundle="${loc}" key="language.errorBalance"/>
                     </ font>
                     <h5>
                  </c:if>
               </td>
               ...
               <td>
                  <c:if test="${pay}">
                     <h5>
                     <font color = "red">
                     <fmt:message bundle="${loc}" key="language.orderPay"/>
                     </ font>
                     <h5>
                  </c:if>
               </td>
      ...
      <div align="center">
         <c:if test="${refuse}">
            <h4>
               <font color = "red">
               <fmt:message bundle="${loc}" key="language.refuseMessage"/>
               </ font>
            </h4>
         </c:if>
      </div>
